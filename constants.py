...
ENHANCED_WAVE_MIN = 3
ENHANCED_WAVE_MAX = 5
# x2 хп — если факелы потушены уже ПОСЛЕ зачистки обычных врагов комнаты
ENHANCED_HEALTH_MULT = 2.0
# x3 хп — если факелы потушены, пока обычные враги комнаты ещё живы
# (более рискованный тайминг для игрока — выше награда/опасность)
ENHANCED_HEALTH_MULT_EARLY = 3.0
ENHANCED_DAMAGE_MULT = 1.4
ENHANCED_BOSS_HEALTH_MULT = 2.0  # доп. босс в босс-комнате при разрушении факелов — x2 хп от обычного босса
# Награда за зачистку усиленной волны — ОДИН сундук на комнату (не с
# каждого врага), спавнится когда умирает последний enhanced-враг волны
NORMAL_MOB_CHEST_CHANCE = 0.001  # 0.1% — редкий доп. сундук с ЛЮБОГО обычного (не enhanced) врага